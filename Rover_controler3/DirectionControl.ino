...
void decide_direction() {
  ...
  if(obs_array[0] == 1  && obs_array[1] == 0  && obs_array[2] == 0) {
       ...
       brake();
       body_rturn();
       delay(250);	  //was 1000,400,150 - calc at 200, need a little more
       brake();
       return;
   }
  if(obs_array[0] == 0  && obs_array[1] == 0  && obs_array[2] == 1) {
       ...
       brake();
       body_lturn();
       delay(235);	//was 1000,400,135 - calc at 185
       brake();
       return;
   }
  ...
  if(obs_array[0] == 0  && obs_array[1] == 1  && obs_array[2] == 1) {
       ...
       brake(); 
       body_lturn();
       delay(325);	 //was 1500, 225 - calcd at 275	   
       brake();
       return;
   }
